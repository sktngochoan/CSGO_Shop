    ...
    <head>
        ...
        <script type = "text/javascript">
            ...
            function doDelete(id) {
                if (confirm("Are you sure to delete Skin with ID = " + id + " ?")) {
                    window.location = "delete-skin?skinId=" + id;
                }
            }
        </script>
    </head>
                    ...
                    <table class="product-list">
                        ...
                        <c:forEach items="${listProduct}" var="i">
                            <tr>
                                ...
                                <td>${i.skinQuantity}</td>
                                <td>${i.createdDate}</td>
                                <td>${i.skinPrice}</td>
                                <td><a href="createProduct"><i id="create" class="fas fa-plus"></i></a> <a href="update-skin?skinId=${i.skinId}"><i class="fas fa-edit" id="edit"></i></a> <a onclick="doDelete('${i.skinId}')" href="#"><i class="fas fa-trash" id="delete"></i></a></td>
                            </tr>
                        </c:forEach>
                    </table>
                </div>
